                    ...
                    <div className="relative overflow-hidden rounded-lg">
                        ...
                        <div className="absolute bottom-5 left-0 w-full text-center">
                            <div
                                ...
                                <p className="text-body-color dark:text-dark-6 text-xs">Web Developer</p>
                                <div>
                    ...
                    <div className="relative overflow-hidden rounded-lg">
                        ...
                        <div className="absolute bottom-5 left-0 w-full text-center">
                            <div
                                ...
                                <p className="text-body-color dark:text-dark-6 text-xs">App Developer</p>
                                <div>
                                <span className="absolute left-0 bottom-0">
                                    <svg
                                        width="61"
                    ...
                    <div className="relative overflow-hidden rounded-lg">
                        ...
                        <div className="absolute bottom-5 left-0 w-full text-center">
                            <div
                                ...
                                <p className="text-body-color dark:text-dark-6 text-xs">UI/UX Designer</p>
                                <div>
                                <span className="absolute left-0 bottom-0">
                                    <svg
                                        width="61"
                    ...
                    <div className="relative overflow-hidden rounded-lg">
                        ...
                        <div className="absolute bottom-5 left-0 w-full text-center">
                            <div
                                ...
                                <p className="text-body-color dark:text-dark-6 text-xs">Sales Manager</p>
                                <div>
                                <span className="absolute left-0 bottom-0">
                                    <svg
                                        width="61"
