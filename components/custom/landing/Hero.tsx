  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 text-center ">
      <p className="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        Welcome to
        <span className="border-b border-dotted border-slate-300 ml-1">CongoMetrix</span>
      </p>
      ...
      <h1 className="hero mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="inline-block mt-[-2.5vw] text-[35vw] sm:text-[34vw] lg:text-[16vw] font-display uppercase text-center tracking-tight leading-none relative z-10">
        of Data
        </span>  
      ...
      {/* <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        ...
        <span className="inline-block">with Our Comprehensive Dataset Platform.</span>
      </p> */}
      ...
      <div className="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
        ...
        >
          ...
          <span className="ml-3">Explore Datasets</span>
        </Link>
        <div
        ...
        >
          ...
          >
            ...
            <span className="ml-3">Read documentation</span>
          </button>
          </Link>
        </div>
      </div>
